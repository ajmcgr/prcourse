          ...
          {courseData.map((chapter, index) => (
            <SidebarGroup key={chapter.id}>
              <Collapsible 
                ...
                className="w-full"
              >
                <CollapsibleTrigger className="flex items-center justify-between w-full px-4 py-1.5 hover:bg-sidebar-accent rounded-md">
                  <SidebarGroupLabel asChild className="text-base font-medium m-0 p-0 leading-tight">
                    <span>
                      ...
                      {chapter.lessons.map((lesson) => (
                        <SidebarMenuItem key={lesson.id}>
                          <SidebarMenuButton 
                            ...
                            className="text-sm py-1 leading-tight"
                          >
