    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="overflow-x-auto rounded-lg shadow">
          <Table>
            <TableCaption>Complete PR course content overview</TableCaption>
            <TableHeader>
              <TableRow className="bg-pr-main hover:bg-pr-main">
                <TableHead className="text-white font-bold w-16 text-center">#</TableHead>
                <TableHead className="text-white font-bold w-48">Topic</TableHead>
                <TableHead className="text-white font-bold">Brief Synopsis</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {courseModules.map((module) => (
                <TableRow key={module.id} className="bg-white">
                  <TableCell className="font-medium text-center">{module.id}</TableCell>
