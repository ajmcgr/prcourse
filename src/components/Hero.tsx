...
const Hero: React.FC = () => {
  ...
  return (
    <div className="relative h-auto md:h-[60vh] flex items-center bg-white -mt-16 pb-12 pt-32 md:pt-20"> 
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 md:py-32 flex flex-col items-center text-center">
        <p className="text-xs md:text-sm tracking-normal font-medium text-gray-600 mb-6 animate-fade-in">
        ...
        <p className="mt-7 md:mt-8 text-lg md:text-xl lg:text-2xl max-w-3xl animate-fade-in text-gray-700" style={{animationDelay: '0.2s'}}>
          A comprehensive course from Alex MacGregor featuring essays and video lessons to elevate your PR strategy and execution.
        </p>
        
        <div className="mt-10 md:mt-14 w-full animate-fade-in" style={{animationDelay: '0.4s'}}>
        ...
        <div className="flex justify-center mt-8 text-gray-700 animate-fade-in" style={{animationDelay: '0.5s'}}>
          <div className={`flex ${isMobile ? 'flex-col space-y-3' : 'flex-row items-center space-x-4'} text-sm md:text-base font-medium`}>
