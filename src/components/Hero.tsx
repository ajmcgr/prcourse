...
const Hero: React.FC = () => {
  return (
    <div className="relative h-[90vh] flex items-center bg-white -mt-16">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 pt-32 flex flex-col items-center text-center">
        ...
        <div className="flex justify-center mt-4 text-gray-700 animate-fade-in" style={{animationDelay: '0.5s'}}>
